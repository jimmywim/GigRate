...
namespace GigRate.Controllers
{
    public class StagesController : Controller
    {
        ...
        // GET: Stages/AtEvent?Id=1
        public ActionResult AtEvent(int? Id)
        {
            var eventInstanceStages = db.EventInstanceStages.Where(e => Id == e.EventInstanceId).Include(e => e.Stage);
            var stages = from s in eventInstanceStages
                         select s.Stage;

            return View("Index", stages.ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "Name")] Stage stage)
        {
